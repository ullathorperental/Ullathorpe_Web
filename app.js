  ...
  <div class="contact-block">
    <div class="inner">
      ...
      <div class="contact-wsp-wrap" style="display:flex; flex-direction:column; gap:1rem; align-items:center; padding-bottom: 4rem;">
        <button class="wsp-big" style="background: linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%); box-shadow: 0 8px 24px rgba(225, 48, 108, 0.3);" onclick="window.open('https://www.instagram.com/ullathorpe.rental', '_blank')">
